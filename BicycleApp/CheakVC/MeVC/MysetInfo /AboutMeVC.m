...
-(NSMutableArray*)arr{
    ...
    if(!_arr){
        _arr =[NSMutableArray arrayWithObjects:@{@"title":@"微信公众号",@"content":@"bikeBox"},@{@"title":@"联系电话",@"content":@"021-55698974"},@{@"title":@"电子邮箱",@"content":@"admin@baibaobike.com"},@{@"title":@"官方网站",@"content":@"http://www.baibaobike.com"} ,nil];
    }
    return _arr;
}
